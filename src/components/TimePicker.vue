<template>
  ...
  >
    <template v-slot:activator="{ props }">
      <v-text-field color="primary" bg-color="containerBg" v-model="formatDate"  v-bind="props" readonly  variant="outlined" append-inner-icon="mdi-calendar-month-outline" :label="label" ></v-text-field>
    </template>
